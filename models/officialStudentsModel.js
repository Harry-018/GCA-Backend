...
export const getParents = async ({ search = "", page = 1, limit = 10 }) => {
  ...
  let query = db
    ...
    .innerJoin("applications as a", "ap.application_id", "a.application_id")
    .innerJoin("app_approval as aa", "a.application_id", "aa.application_id")
    .innerJoin(
      "submissions as sub",
      "aa.app_approval_id",
      "sub.app_approval_id",
    )
    .innerJoin("students as s", "sub.submission_id", "s.submission_id")
